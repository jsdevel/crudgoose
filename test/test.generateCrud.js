...
describe("generateCrud", function(){
    ...
    it("should pass a vars composite to generateModelVars", function(){
        sinon.assert.calledWith(
            generateModelVars,
            "_createModelVars",
            config,
